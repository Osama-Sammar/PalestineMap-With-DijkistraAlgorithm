	...
	public void readFromFile(String path1, String path2) {
		...
		try {
			...
			while (scan1.hasNextLine()) {
				...
				str1 = line1.split(" ");
				vertex[Tracker] = new Vertex(str1[0], Integer.parseInt(str1[1]), Integer.parseInt(str1[2]));
				Tracker++;
			}
			...
			while (scan2.hasNextLine()) {
				...
				vertex[index1].adjacent.add(new Adjacent(findVertex(str2[1]), Integer.parseInt(str2[2])));
				vertex[index2].adjacent.add(new Adjacent(findVertex(str2[0]), Integer.parseInt(str2[2])));
				Tracker++;
			}
